...
user_pref("dom.caches.enabled", false);
 ...
 user_pref("security.ssl.enable_ocsp_stapling", true); // [DEFAULT: true FF26+]
...
user_pref("browser.safebrowsing.malware.enabled",		true);
 ...
 // 7003: disable non-modern cipher suites
    // [-] https://bugzilla.mozilla.org/172407
     // 3DES
 // ***/
...
user_pref("privacy.firstparty.isolate.use_site", true);
 ...
 user_pref("privacy.resistFingerprinting.block_mozAddonManager", true); // [HIDDEN PREF]
 user_pref("privacy.resistFingerprinting.letterboxing", false); // [HIDDEN PREF]
user_pref("privacy.resistFingerprinting.letterboxing.dimensions", "0x0,0x0,0x0,0x0"); // [HIDDEN PREF]
...
user_pref("media.gmp-widevinecdm.enabled", true); // 2021 default-inactive in user.js
 user_pref("media.eme.enabled", false); // 2022
