...
user_pref("browser.ctrlTab.recentlyUsedLimit", 10);
user_pref("browser.history_expire_days", 0);
user_pref("browser.history_expire_sites", 0);
user_pref("network.cookie.cookieBehavior", 1);
user_pref("network.security.esni.enabled", true); 
user_pref("network.security.esni.enabled_static", true); 
user_pref("network.security.esni.enabled_tests", true); 
user_pref("network.security.esni.strict_mode", true); 
user_pref("network.security.rrsetOrder", true); 
user_pref("network.dns.echconfig.enabled", true);
user_pref("network.dns.echconfig.fallbackToECH", true); 
user_pref("network.trr.mode", 3);
user_pref("network.trr.uri", "https://dns.mullvad.net/dns-query"); 
user_pref("network.trr.bootstrapAddress", "193.138.218.74");
user_pref("network.trr.bootstrapAddress", "[2001:67c:2b0::4]"); 
